...
namespace NLayer.Caching
{
    public class ProductServiceWithCaching : IProductService
    {
        ...
        public ProductServiceWithCaching(IUnitOfWork unitOfWork, IProductRepository repository, IMemoryCache memoryCache, IMapper mapper)
        {
            ...
            {
                _memoryCache.Set(CacheProductKey, _repository.GetProductsWitCategory());
            }
        ...
        public Task<CustomeResponseDto<List<ProductWithCategoryDto>>> GetProductsWitCategory()
        {
            var products = _memoryCache.Get<IEnumerable<Product>>(CacheProductKey);
        ...
        //Task<List<ProductWithCategoryDto>> IProductService.GetProductsWitCategory()
        //{
        //    throw new NotImplementedException();
        //}
    }
