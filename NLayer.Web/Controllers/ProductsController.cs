...
namespace NLayer.Web.Controllers
{
    public class ProductsController : Controller
    {
        ...
        {
            return View(await _service.GetProductsWitCategory());
        }
        ...
        public async Task<IActionResult> Update(int id)
        {
            ...
            var categories = await _categoryService.GetAllAsync();
            var categoryiesDto = _mapper.Map<List<CategoryDto>>(categories.ToList());
            ViewBag.categoryies = new SelectList(categoryiesDto, "Id", "Name",product.CategoryId);
        ...
        public async Task<IActionResult> Update(ProductDto productDto)
        {
            ...
            var categories = await _categoryService.GetAllAsync();
            var categoryiesDto = _mapper.Map<List<CategoryDto>>(categories.ToList());
            ViewBag.categoryies = new SelectList(categoryiesDto, "Id", "Name", productDto.CategoryId);
